...
public class Practice01AfterOnDrawView extends AppCompatImageView {
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    if (BuildConfig.DEBUG && drawable != null) {
      ...
      int w = rect.width();
      int h = rect.height();
      String text = getResources().getString(R.string.image_size, w, h);
      canvas.save();
      canvas.concat(getImageMatrix());//图片的Matrix
      //canvas.drawText(text, drawable.getIntrinsicWidth() + 20, 40, paint);
