  ...
  @Override protected void onAttachedToWindow() {
    ...
    animateBt.setOnClickListener(new OnClickListener() {
      @Override public void onClick(View v) {
        ...
        Keyframe keyframe1 = Keyframe.ofFloat(0.5f, 80);
        // 结束帧：progress 回落到 80
        Keyframe keyframe2 = Keyframe.ofFloat(0.75f, 50);
        Keyframe keyframe3 = Keyframe.ofFloat(1, 100);
        // 使用 PropertyValuesHolder.ofKeyframe() 来把关键帧拼接成一个完整的属性动画方案
        PropertyValuesHolder progress =
            PropertyValuesHolder.ofKeyframe("progress", keyframe, keyframe1, keyframe2, keyframe3);
        // 使用 ObjectAnimator.ofPropertyValuesHolder() 来创建动画
        ObjectAnimator.ofPropertyValuesHolder(view, progress).setDuration(3000).start();
      }
    });
  }
}
